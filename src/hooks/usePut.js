...
const usePut = () => {
   ...
   * @param { integer } id - ID gambar yang akan diperbarui.
   * @param { integer } kd_penelitian - Kode Penelitian.
   * @param { string } judul - Judul Penelitian.
   * @param { string } lokasi - Lokasi Penelitian.
   * @param { integer } thn_akademik - Tahun Akademik Penelitian.
   * @param { Date } tanggal - Tanggal Penelitian.
